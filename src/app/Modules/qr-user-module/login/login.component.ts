...
export class LoginComponent implements OnInit {
  ...
  private async setLoginSession(response: any): Promise<void> {
    ...
    this.sharedService.setItem('businessId', response.id);
    this.sharedService.setItem('expirationDate', response.expirationDate);
    this.sharedService.setItem('planType', response.planType);
    this.sharedService.setItem('planExpiration', response.planExpiredAt);
    this.sharedService.setItem('currentPlan', response.current);
  }
